...
public class FeedbackService {
    ...
    private static final String DIR_PATH = "db/feedback";

    private final GitJsonDirectoryCrudSupport crud;

    public FeedbackService(GitJsonDirectoryCrudSupport crud) {
        this.crud = crud;
    }
    ...
    public ApiResult delete(DataRequest req) {
        return crud.deleteFromDirectory(req, DIR_PATH, "Missing feedback id", "Delete feedback");
    }
}
